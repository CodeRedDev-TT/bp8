...
(function ($) {
    ...
    AIZ.uploader = {
        ...
        deleteUploaderFile: function () {
            ...
            $(".aiz-uploader-confirmed-delete").each(function () {
...
//                    $("#aizUploaderDelete").modal("show");
        ...
        getAllUploads: function (url, search_key = null, sort_key = null) {
            ...
            $.get(url, params, function (data, status) {
                ...
                AIZ.uploader.data.thefiles = data.data;
        ...
        updateUploaderFiles: function () {
            ...
            var data = AIZ.uploader.data.thefiles;
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].type === "image") {
                            ...
                            thumb = '<i class="bi bi-card-text"></i>';
                        }
                        var html =
                            ...
                            "." +
                            data[i].extension +
                            '" class="dropdown-item"><i class="bi bi-download mr-2"></i>Download</a>' +
                            '<a href="#" class="dropdown-item aiz-uploader-confirmed-delete" data-id="' +
                            data[i].id +
                            '"><i class="bi bi-trash mr-2"></i>Delete</a>' +
                            "</div>" +
                            "</div>" +
