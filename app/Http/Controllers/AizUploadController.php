            ...
            if (isset($type[$extension])) {
                ...
                if ($type[$extension] == 'image') {
                    try {
                        ...
                        $img->orientate();
                        $img->save(base_path('storage/app/public/') . $path);
                        $size = $img->filesize();
                    ...
                    Storage::disk('public')->put($path, $request->file('aiz_file'));
                }
    ...
    public function destroy($id)
    {
        try {
            if (env('FILESYSTEM_DRIVER') == 's3') {
                ...
                unlink(base_path('public/') . Upload::where('id', $id)->first()->file_name);
            }
            Upload::destroy($id);
